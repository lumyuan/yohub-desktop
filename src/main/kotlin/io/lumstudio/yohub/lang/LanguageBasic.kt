...
abstract class LanguageBasic(
    ...
    val appDisabled: String,
    val textPickup: String,
    val textDisable: String,
    val textEnable: String,
    val textUninstall: String,
    val noticeAppEnabled: String,
    val noticeAppEnabledMessage: String,
    val noticeAppEnabledFail: String,
    val noticeAppDisabled: String,
    val noticeAppDisabledMessage: String,
    val noticeAppDisabledFail: String,
    val noticeAppUninstall: String,
    val noticeAppUninstallMessage: String,
    val noticeAppUninstallFail: String,
    val dialogUninstallApp: String,
    val magiskVersion: String,
    val labelFastRoot: String,
    val titleFastRoot: String,
    val subtitleFastRoot: String,
